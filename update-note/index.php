<?php
$baseUrl = "../";
include $baseUrl."common/common.php";
$page_title = "laomao.website 的最新变化";
?>
<!DOCTYPE html>
<html lang="zh">
...
<div class="about">
    <div class="model">
        ...
        <ol>
            ...
            <li>【开发中】单独创建一则新闻与公告详情页；历史公告也会予以存档，全部集中于网站公告列表页面；</li>
            <li>【评估中】特殊关键字触发的工具小部件；</li>
            <li>【评估中】Laomao 自建检索系统优化；</li>
            <li>【待评估】NESG 账户系统对接，首页基础排版与内容自定义功能；设置同步功能</li>
        </ol>
        <h3 id="20221119">2022年11月19日更新</h3>
        <h4>基础</h4>
        <ol>
            <li>【已推送】天气设置功能调整，添加省市县区三级联动选择功能，不必繁琐配置区域代码；</li>
            <li>【已推送】对“搜索或键入网址”功能进行改进，对一般网址的判断进行算法优化；更新更多第三方搜索引擎，添加自定义搜索引擎选项；</li>
        </ol>
