...
<div class="footer">
    ...
    <p>
        <a href="<?php echo $baseUrl ?? '' ?>about.php?classify=EULA">服务条款与隐私权政策</a>
        |
        <a href="<?php echo $baseUrl ?? '' ?>about.php?classify=about">关于本站</a>
        |
        <a href="<?php echo $baseUrl ?? '' ?>about.php?classify=license">开放源代码许可</a>
        |
...
<!--外部JavaScript脚本-->
<script type="module" src="<?php echo $baseUrl ?? '' ?>common/theme/eyefind/assets/js/main.js?v=<?php echo $GLOBALS['SITE_VERSION'] ?? '' ?>"></script>
